...
const (
	...
	AuthService_ValidateJWTToken_FullMethodName = "/auth.AuthService/ValidateJWTToken"
)
...
func (c *authServiceClient) ValidateJWTToken(ctx context.Context, in *ValidateJWTTokenRequest, opts ...grpc.CallOption) (*ValidateJWTTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ValidateJWTTokenResponse)
	err := c.cc.Invoke(ctx, AuthService_ValidateJWTToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) ValidateJWTToken(context.Context, *ValidateJWTTokenRequest) (*ValidateJWTTokenResponse, error) {
...
func _AuthService_ValidateJWTToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateJWTTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).ValidateJWTToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_ValidateJWTToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ValidateJWTToken(ctx, req.(*ValidateJWTTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_ValidateJWTToken_Handler,
		},
	},
